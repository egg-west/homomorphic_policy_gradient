...
from models.cnn import PixelEncoder, DoublePixelEncoder
...
class DrQV2Agent:
    def __init__(self, obs_shape, action_shape, device, lr, feature_dim, hidden_dim,
        ...
        self.pixel_encoder = DoublePixelEncoder(obs_shape, feature_dim).to(device)
        self.actor = DrQActor(feature_dim*2, action_shape[0], hidden_dim).to(device)
